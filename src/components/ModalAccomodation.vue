...
export default {
  ...
  methods:{
    ...
    validateForm(){      
      ...
      if(this.validName == true && this.validEmail == true && this.validDesc == true && this.validCoords == true && this.validUrl == true){
        this.sendForm();
      }      
    },
    ...
    sendForm(){
      var encodedFormData = this.encodeForm();
      ...
      xhttp.open("POST", corsfix + "http://www.wallemdesign.com/server/add-establishments-success.php", true);
    ...
    encodeForm(){
      var encodeLat = encodeURI(this.coords.lat);
      var encodeLng = encodeURI(this.coords.lng);      
      var encodeName = encodeURI(this.estName);
      var encodeMail = encodeURI(this.email);
      var encodeDesc = encodeURI(this.desc);
      var encodeUrl = encodeURI(this.url);
      var encodeGuests = encodeURI(this.guests);
      var encodePrice = encodeURI(this.price);
      var encodeCatering = encodeURI(this.selfCatering);
      var encodeId = encodeURI(this.id);

      var encodedForm = 
        "establishmentName=" + encodeName + 
        "&establishmentEmail=" + encodeMail +
        "&imageUrl=" + encodeUrl +
        "&price=" + encodePrice +
        "&maxGuests=" + encodeGuests +
        "&googleLat=" + encodeLat + 
        "&googleLong=" + encodeLng +
        "&description=" + encodeDesc +
        "&selfCatering=" + encodeCatering +
        "&id=" + encodeId        
      ;
      return encodedForm;
    }
