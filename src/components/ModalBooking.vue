  ...
  <div class="[ booking ]">
    ...
    <div class="[ booking__wrapper ]">     
      ...
      <form @submit.prevent  v-if="showFrom">        
        ...
        <div class="[ booking__checkin ]" v-if="checkinDate">
        ...
        <div class="[ booking__checkin ]" v-if="checkoutDate">
        ...
        <div class="[ calendar ]" v-if="showCalendar">
          ...
          <div class="[ calendar__header ]">
            <button class="[ back ]" @click="prevMonth"> Prev </button>
            <h3> {{monthArray[month]}}  {{year}} </h3>
            <button class="[ back ]" @click="nextMonth"> Next </button>
          </div>
        ...
        <input class="[ booking__input ]" type="text" name="name" 
          v-model="name" 
        ...
        <input class="[ booking__input ]" type="text" name="email" 
          v-model="email" 
          v-on:blur="validateEmail"
          v-bind:class="{ error: errorEmail }"
        >
        <button class="[ booking__submit ]" type="submit" @click="validateForm"> Confirm Booking </button>
      </form>
    </div>
